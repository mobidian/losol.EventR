...
namespace losol.EventR.Data.Migrations
{
    ...
    [Migration("20161227202401_profile-update2")]
    partial class profileupdate2
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("losol.EventR.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("losol.EventR.Models.ApplicationUser")
                        .WithMany("Claims")
